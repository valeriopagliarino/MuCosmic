...
HD_PWD='C:/XilinxProjects/redpitaya-fpga-example-template/adc_dac_control.runs/system_adc_processing_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_adc_processing_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_adc_processing_0_0.tcl
