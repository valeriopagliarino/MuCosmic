...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../adc_dac_control.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../adc_dac_control.srcs/sources_1/bd/system/ipshared/5765/hdl" \
       +incdir+"../../../../adc_dac_control.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../adc_dac_control.srcs/sources_1/bd/system/ipshared/5765/hdl" \
